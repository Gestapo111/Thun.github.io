...
function requestAccess() {
    ...
    const nie = prompt("Por favor, ingrese su NIE (Número de Identificación Estudiantil):");
    ...
    const allowedEmails = [
        ...
        "67890@cleses.edu.sv",
        "11223@cleses.edu.sv"
        // Agrega aquí más correos permitidos
    ];

    if (allowedEmails.includes(email)) {
        document.getElementById("content").style.display = "block";
        document.getElementById("nie").value = nie; // Asigna el NIE al campo del formulario
    } else {
